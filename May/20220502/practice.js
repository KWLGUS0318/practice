...
//let one; // Todo : 변수 선언은 했고, 값은 무엇을 '가리키지는' 않은 상태 
1;
// todo: 식별을 위해서 값과 변수를 대입하는 과정을 통한다. = (이퀄표시)

//let test = 1; // ? 변수 선언과 동시에 값을 가리켰다. 초기화되었다.
...
//const two = 1; // ?변수 선언과 동시에 값도 같이 가리키게 만든다. const의규칙 
// * 에러가 났다 === 해결만 한다면 무결해짐
